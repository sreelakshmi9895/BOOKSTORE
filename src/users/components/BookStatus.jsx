...
function BookStatus() {
  ...
  <img  width={'90px'} height={'90px'} src="https://w7.pngwing.com/pngs/568/351/png-transparent-computer-icons-sold-out-miscellaneous-text-logo.png" alt="" />
   ...
   <img w-50 src="https://speakingtigerbooks.com/wp-content/uploads/2024/10/Everyday-Reading_Final.jpg" alt="" />
   <button className='p-2 bg-red-600 txt-white'>DELETE</button>
      </div>
    </div>
  )
}
